...
Deno.serve(async (req) => {
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for audio-files" ON storage.objects FOR SELECT USING (bucket_id = 'audio-files');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for audio-files" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'audio-files');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for audio-files" ON storage.objects FOR UPDATE USING (bucket_id = 'audio-files');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for audio-files" ON storage.objects FOR DELETE USING (bucket_id = 'audio-files');`
    ];

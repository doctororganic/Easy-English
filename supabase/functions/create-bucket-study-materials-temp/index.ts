...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "image/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Access for study-materials" ON storage.objects FOR SELECT USING (bucket_id = 'study-materials');`,
        // Allow public to insert objects in this bucket
        `CREATE POLICY "Public Upload for study-materials" ON storage.objects FOR INSERT WITH CHECK (bucket_id = 'study-materials');`,
        // Allow public to update objects in this bucket
        `CREATE POLICY "Public Update for study-materials" ON storage.objects FOR UPDATE USING (bucket_id = 'study-materials');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for study-materials" ON storage.objects FOR DELETE USING (bucket_id = 'study-materials');`
    ];
